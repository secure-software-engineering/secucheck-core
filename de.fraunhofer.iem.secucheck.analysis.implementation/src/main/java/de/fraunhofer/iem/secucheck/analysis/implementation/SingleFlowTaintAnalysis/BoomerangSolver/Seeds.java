...
class Seeds {
    ...
    public void setSources(Set<ForwardQuery> sources) {
        this.sources = sources;
    }

    public void setSinks(Set<BackwardQuery> sinks) {
        this.sinks = sinks;
    }

    public Set<ForwardQuery> getSources() {
        return sources;
    }

    public Set<BackwardQuery> getSinks() {
        return sinks;
    }
}
